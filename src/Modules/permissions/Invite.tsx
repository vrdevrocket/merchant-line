...
export const ModuleInviteMerchant = (props: IProps) => {
    //page hook
                ...
                return (
                    ...
                    >
                        ...
                        <div className="visible-md">
                            <p className="delete-field visible-md" onClick={handleDelete}>
                        ...
                        <div className="visible-ms footer-layout">
                            <div className="btn-layout">
                                <SharedButtonDefault
                                    className="delete-btn"
                                    type="primary"
                                    text={t("page.delete_user")}
    ...
    return (
        <Drawer
            ...
            placement={"bottom"}
            height={"90vh"}
            className="invit-layout"
        >
            <ScrollContainer style={{ overflowY: "scroll", height: "calc(100vh - 160px)" }}>
                <Container>
                    <div>
