import { enumDrawerPlacement, enumMobileSidebar } from "@configs";
...
const initialState: IState = {
    ...
    sidebarPosition: 0,
    profileDrawer: false,
    currentMenu: enumMobileSidebar.LOYALTY,
};
...
const appSlice = createSlice({
    ...
    reducers: {
        setSidebarPosition: (state, action: PayloadAction<number>) => {
        ...
        setMobileDrawer: (state, action: PayloadAction<boolean>) => {
            ...
            state.profileDrawer = false;
        },
        setProfileDrawer: (state, action: PayloadAction<boolean>) => {
            state.profileDrawer = action.payload;
            state.mobileDrawer = false;
        },
        setMobileMenu: (state, action: PayloadAction<enumMobileSidebar>) => {
